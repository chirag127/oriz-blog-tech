...
> Software, drawn to scale — deep, buildable notes on shipping and running production software.

[![License: MIT](https://img.shields.io/badge/License-MIT-e4572e.svg)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/chirag127/oriz-blog-tech?style=flat)](https://github.com/chirag127/oriz-blog-tech/stargazers)
[![Last commit](https://img.shields.io/github/last-commit/chirag127/oriz-blog-tech)](https://github.com/chirag127/oriz-blog-tech/commits/main)
[![Deploy](https://github.com/chirag127/oriz-blog-tech/actions/workflows/deploy.yml/badge.svg)](https://github.com/chirag127/oriz-blog-tech/actions/workflows/deploy.yml)
[![Built with Astro](https://img.shields.io/badge/built%20with-Astro-ff5d01.svg)](https://astro.build)

**Tech** is a static, content-first blog built with Astro and deployed to Cloudflare Pages.
A software-engineering blog for developers. Every post reads like an engineering drawing set — dimensioned so you can build from it.

- **Live site:** https://tech-blog.oriz.in · **Repo:** https://github.com/chirag127/oriz-blog-tech
- **GitHub Pages landing:** https://chirag127.github.io/oriz-blog-tech/ — the canonical, always-current site is **https://tech-blog.oriz.in** (Cloudflare Pages); GitHub Pages is not the deploy target for this repo.

> ⭐ **If this is useful, please [star the repo](https://github.com/chirag127/oriz-blog-tech/stargazers)** — it helps others find it.
...
flowchart LR
    ...
    D --> E["Cloudflare Pages<br/>tech-blog.oriz.in"]
...
oriz-blog-tech/
├── src/
│   ├── content/blog/       # the engineering write-ups (MDX/Markdown)
