...
|---|---|---|
| AI agents / LLM apps | IBM RAG and Agentic AI (Coursera); Scrimba AI Engineering (only mainstream course that covers MCP) | Multi-agent support system: a router agent + tool-using worker agents, live demo, cost-per-request logged in the README |
...
| Kubernetes / DevOps | Certified Kubernetes Administrator (CKA); Docker & Kubernetes Masterclass (Packt) | Home cluster manifests: deployment, HPA, ingress, health probes, a broken-pod runbook in the README |
